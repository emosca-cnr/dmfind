...
knitr::include_graphics("imgs/eval_eps_X0.jpg")
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("imgs/eval_eps_X0_omega.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("imgs/NR.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("imgs/cmp_X0_ND.jpg")
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("imgs/top_net_enrichment.jpg")
```
...
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("imgs/x_comm_network.png")
```

## Visualization - network of communities
```{r include=TRUE}
comm_net(top_network)
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("imgs/comm_net.jpg")
```
...
```{r include=TRUE}
pc_wmz(top_network, do_plot=T)
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("imgs/pc_wmz.jpg")
```
...
```{r include=TRUE}
NetComp(NetList, union=T, intersection=T, centrMeas=T, ji=T)
```
