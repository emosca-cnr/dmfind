...
knitr::include_graphics("/home/bioinformatics/vnale/dmfind/vignettes/eval_eps_X0.jpg")
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/home/bioinformatics/vnale/dmfind/vignettes/eval_eps_X0_omega.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/home/bioinformatics/vnale/dmfind/vignettes/NR.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/home/bioinformatics/vnale/dmfind/vignettes/cmp_X0_ND.jpg")
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/home/bioinformatics/vnale/dmfind/vignettes/top_net_enrichment.jpg")
```
...
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/home/bioinformatics/vnale/dmfind/vignettes/graph.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/home/bioinformatics/vnale/dmfind/vignettes/pc_wmz.jpg")
```
