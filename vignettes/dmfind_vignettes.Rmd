...
knitr::include_graphics("/Users/valentina/Downloads/dmfind/vignettes/imgs/eval_eps_X0.jpg")
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/Users/valentina/Downloads/dmfind/vignettes/imgs/eval_eps_X0_omega.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/Users/valentina/Downloads/dmfind/vignettes/imgs/NR.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/Users/valentina/Downloads/dmfind/vignettes/imgs/cmp_X0_ND.jpg")
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/Users/valentina/Downloads/dmfind/vignettes/imgs/top_net_enrichment.jpg")
```
...
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/Users/valentina/Downloads/dmfind/vignettes/imgs/graph.jpg")
```
...
```
```{r fig.width=4, echo=FALSE, warning=FALSE, message=F, results='show', eval=TRUE} 
knitr::include_graphics("/Users/valentina/Downloads/dmfind/vignettes/imgs/pc_wmz.jpg")
```
